...
if __name__ == '__main__':
    ...
    Process the OTIS internal flat fields for 1078 (NIS readout) by
    manually specifying the superdark and superbias reference files,
    which were already grabbed from the CRDS directory.
    ...
    parser.add_argument('-d', '--dr', '--directory', default = '/witserv/data18/martel/commissioning/1078/lamps_OTIS/NIS/', dest = 'dir', type = str, action = 'store', help = "Directory of the _uncal.fits exposures.")  
    parser.add_argument('-c', '--cw', '--calwebb',   default = 'calwebb_detector1_1078_lamps_OTIS_NIS.cfg', dest = 'calw', type = str, action = 'store', help = "calwebb_detector1 file to use.")  
